<div class="profile-component-card" style="font-family: 'Inter', 'Segoe UI', system-ui, sans-serif;">
    <div class="px-5 pt-5 pb-2">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex items-center gap-3">
                <!--[if BLOCK]><![endif]--><?php if(\Illuminate\Support\Facades\Route::has('committees.create')): ?>
                    <a href="<?php echo e(route('committees.create')); ?>" class="text-gray-600 hover:text-gray-800" title="Add committee">
    ...
    <div class="px-5 pb-5">
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $committees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b border-slate-100 hover:bg-slate-50">
                            <td class="p-3 text-slate-900"><?php echo e($c->committee_name); ?></td>
                            <td class="p-3">
                                <!--[if BLOCK]><![endif]--><?php if(\Illuminate\Support\Facades\Route::has('committees.edit')): ?>
                                    <a href="<?php echo e(route('committees.edit', ['committee' => $c->committee_id])); ?>" class="inline-flex items-center justify-center w-8 h-8 rounded-md text-slate-500 hover:bg-slate-50" title="Edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <button wire:click="delete(<?php echo e($c->committee_id); ?>)" wire:confirm="Delete this committee?" class="inline-flex items-center justify-center w-8 h-8 rounded-md text-red-500 hover:bg-red-50" title="Delete">
        ...
        <!--[if BLOCK]><![endif]--><?php if(method_exists($committees, 'hasPages') && $committees->hasPages()): ?>
            <div class="mt-4">
...
<?php /**PATH C:\Users\Marc Ian C. Young\laravel\fceerweb\resources\views/livewire/committee/index.blade.php ENDPATH**/ ?>