<div class="profile-component-card">
	<div class="profile-card-header">
		<div>
			<p class="profile-card-title">Add Highschool</p>
		</div>
		<div class="profile-card-actions">
			<button type="button" class="gear-button text-slate-800" wire:click.prevent="storeHighschool" title="Add">
	...
	<div class="border-t border-slate-200 pt-4">
		<form wire:submit.prevent="storeHighschool">
			@csrf
