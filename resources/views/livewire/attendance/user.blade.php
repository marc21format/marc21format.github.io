                    ...
                    @if($user->role_id == 4)
                        ...
                        <div class="ml-auto flex items-center gap-2">
                            ...
                            @if($currentAttendanceId)
                                <button type="button" wire:click="redirectToCreateExcuse({{ $currentAttendanceId }}, '{{ $session }}')" class="gear-button text-slate-800" title="Add Excuse Letter">
                                    <i class="fa fa-plus"></i>
                                </button>
                            @else
                                <button type="button" wire:click="redirectToCreateExcuse(0, '{{ $session }}')" class="gear-button text-slate-800" title="Add Excuse Letter">
                                    <i class="fa fa-plus"></i>
                                </button>
                            @endif
                        </div>
                            ...
                            <div class="rounded-lg border border-slate-200 bg-white p-4">
                                ...
                                <div class="grid grid-cols-7 gap-1 text-center">
                                    ...
                                    @for($i = 1; $i <= $daysInMonth; $i++)
                                        ...
                                        @endphp
                                        <div
                                            class="h-8 flex items-center justify-center text-sm rounded cursor-pointer transition {{ $isSelected ? 'bg-slate-700 text-white font-semibold' : ($hasRecord ? 'bg-slate-200 text-slate-700 font-medium' : 'text-slate-600 hover:bg-slate-100') }}"
                    ...
                    <div class="rounded-lg border border-slate-200 bg-slate-50/50 p-4">
                        ...
                        @if($reviewSeason)
                            <div class="flex items-center gap-3 mt-4 p-3 rounded-lg border border-indigo-200 bg-indigo-50">
                                ...
                                <span class="text-sm font-semibold text-indigo-900">{{ $reviewSeason->range_label }}</span>
                            </div>
                        @endif
                        ...
                        @if($user->role_id == 4)
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-6 gap-3 mt-4">
                                <div class="rounded-lg border border-green-200 bg-green-50 p-3">
                                    <div class="text-2xl font-bold text-green-700">{{ $analyticsOnTime }}</div>
                                    <div class="text-xs text-green-600">On Time</div>
                                </div>
                                <div class="rounded-lg border border-yellow-200 bg-yellow-50 p-3">
                                    <div class="text-2xl font-bold text-yellow-700">{{ $analyticsLate }}</div>
                                    <div class="text-xs text-yellow-600">Late</div>
                                </div>
                                <div class="rounded-lg border border-red-200 bg-red-50 p-3">
                                    <div class="text-2xl font-bold text-red-700">{{ $analyticsAbsent }}</div>
                                    <div class="text-xs text-red-600">Absent</div>
                                </div>
                                <div class="rounded-lg border border-blue-200 bg-blue-50 p-3">
                                    <div class="text-2xl font-bold text-blue-700">{{ $analyticsExcused }}</div>
                                    <div class="text-xs text-blue-600">Excused</div>
                                </div>
                                <div class="rounded-lg border border-slate-200 bg-slate-50 p-3">
                                    <div class="text-2xl font-bold text-slate-700">{{ $analyticsNA }}</div>
                                    <div class="text-xs text-slate-600">N/A</div>
                                </div>
                                <div class="rounded-lg border border-indigo-200 bg-indigo-50 p-3">
                                    <div class="text-2xl font-bold text-indigo-700">{{ $analyticsTotalDays }}</div>
