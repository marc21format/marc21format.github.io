	...
	<div class="border-t border-slate-200 pt-4">
		<form wire:submit.prevent="save">
			<div class="form-group">
				...
				<select wire:model.defer="highschoolsubject_id" class="form-select">
			...
			<div class="form-group">
				...
				<input type="text" wire:model.defer="grade" class="form-input" />
		...
		<form id="delete-form" method="POST" action="{{ route('users.highschool_subject_records.destroy', [$userId, $recordId ?? $this->recordId]) }}" style="display: none;">
			@csrf
			@method('DELETE')
		</form>
	</div>
